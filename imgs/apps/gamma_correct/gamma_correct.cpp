...
int main(int argc, char* argv[]) {
  ...
  options.add_options()("help,h", "display this message")(
      ...
      "destination filename")("gamma,g", po::value<double>(&gamma),
                              "gamma [default is 2.2]")(
  ...
  cv::Mat dst = ipcv::GammaCorrection(src, gamma, max_value);
  ...
  if (dst_filename.empty()) {
    ...
    cv::imshow(src_filename + " [Gamma Corrected]", dst);
    cv::waitKey(0);
  } else {
